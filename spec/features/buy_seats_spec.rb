...
RSpec.describe 'Buy-One-Seat', type: :system do
  ...
  it 'buy-seat' do
    ...
    find(:xpath, "/html/body/div[2]/div/div[2]/div/div[1]/div[1]/a[1]/div").click
    click_button "Comprar"
    expect(find(:xpath, "/html/body/div[2]/div/div[2]/div/div[1]/div[1]/div[2]").style("background-color")["background-color"]).to eq('rgba(255, 0, 0, 1)')
  end
...
RSpec.describe 'Buy-Multiple-Seats', type: :system do
  ...
  it 'buy-seat' do
    ...
    # find(:xpath, "//a[@href='seats/movie_id=23&room=5&time=2?col=12&row=A']").click
    find(:xpath, "/html/body/div[2]/div/div[2]/div/div[1]/div[1]/a[1]/div").click
    find(:xpath, "/html/body/div[2]/div/div[2]/div/div[1]/div[1]/a[2]/div").click
...
RSpec.describe 'Buy-Seats-On-Different-Rows-Fail', type: :system do
  ...
  it 'buy-seat' do
    ...
    # find(:xpath, "//a[@href='seats/movie_id=23&room=5&time=2?col=12&row=A']").click
    find(:xpath, "/html/body/div[2]/div/div[2]/div/div[1]/div[1]/a[1]/div").click
    find(:xpath, "/html/body/div[2]/div/div[2]/div/div[1]/div[2]/a[1]/div").click
